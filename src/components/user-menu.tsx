  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="border-border hover:bg-accent hover:text-primary-foreground relative h-8 w-8 rounded-full border shadow-sm"
        >
      ...
      <DropdownMenuContent
        className="w-56 bg-popover text-popover-foreground border border-border shadow-lg backdrop-blur-0"
        align="end"
      >
      ...
      <UpsertUserForm isOpen={profileDialogOpen} onOpenChange={setProfileDialogOpen} />
    </DropdownMenu>
  )
}
