...
function AdminDashboardStats() {
  ...
  if (dashboardQuery.isError) {
    return (
      <div className="bg-destructive/15 text-destructive rounded-none p-4">
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-2 sm:px-4">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50 transition-all duration-300 hover:shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Employees</CardTitle>
            <Users className="text-primary h-4 w-4" />
          </CardHeader>
          <CardContent>
            <div className="text-primary text-2xl font-bold">{stats?.totalEmployees}</div>
        ...
        <Card className="rounded-none border-accent/10 bg-card/60 shadow-sm ring-1 ring-border/50 transition-all duration-300 hover:shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Present Today</CardTitle>
            <UserCheck className="text-accent h-4 w-4" />
          </CardHeader>
          <CardContent>
            <div className="text-accent text-2xl font-bold">{stats?.presentToday}</div>
            <p className="text-muted-foreground text-xs">{stats?.attendanceRate.toFixed(1)}% attendance rate</p>
          </CardContent>
        </Card>

        <Card className="rounded-none border-chart-4/10 bg-card/60 shadow-sm ring-1 ring-border/50 transition-all duration-300 hover:shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">On Leave</CardTitle>
            <UserX className="text-chart-4 h-4 w-4" />
          </CardHeader>
          <CardContent>
            <div className="text-chart-4 text-2xl font-bold">{stats?.onLeaveToday}</div>
            <p className="text-muted-foreground text-xs">{stats?.leaveRate.toFixed(1)}% of workforce</p>
          </CardContent>
        </Card>

        <Card className="rounded-none border-chart-3/10 bg-card/60 shadow-sm ring-1 ring-border/50 transition-all duration-300 hover:shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Monthly Payroll</CardTitle>
            <DollarSign className="text-chart-3 h-4 w-4" />
          </CardHeader>
          <CardContent>
            <div className="text-chart-3 text-2xl font-bold">{formatter.format(stats?.monthlyPayroll || 0)}</div>
            <p className="text-muted-foreground flex items-center text-xs">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4 rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          <CardHeader>
        ...
        <Card className="col-span-3 rounded-none border-accent/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          <CardHeader>
...
function ManagerDashboardStats() {
  ...
  if (teamAttendanceQuery.isError || teamLeaveQuery.isError) {
    return (
      <div className="bg-destructive/15 text-destructive rounded-none p-4">
        Error loading dashboard data: {teamAttendanceQuery.error?.message || teamLeaveQuery.error?.message}
      </div>
    )
  }
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 px-2 sm:px-4">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card className="rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">{attendanceData?.attendanceRate.toFixed(1)}% of team</p>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">{attendanceData?.leaveRate.toFixed(1)}% of team</p>
          </CardContent>
        </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-7 rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          <CardHeader>
    ...
    <div className="mx-auto max-w-7xl space-y-6 px-2 sm:px-4">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatter.format(stats?.lastPayrollAmount || 0)}</div>
            <p className="text-muted-foreground text-xs">{stats?.lastPayrollDate || ""}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-7 rounded-none border-primary/10 bg-card/60 shadow-sm ring-1 ring-border/50">
          <CardHeader>
            ...
            <CardDescription>Daily attendance record for the last 30 days</CardDescription>
          </CardHeader>
          <CardContent>
            <AreaChartComponent
