...
import { Clock, Calendar, TrendingUp, Users, Coffee, Timer } from "lucide-react"
...
export function AttendanceSummaryCard({ employeeId, showEmployeeSelector = false }: AttendanceSummaryCardProps) {
  ...
  if (summaryQuery.isError) {
    return (
      <Card>
        ...
        <CardContent>
          <div className="py-8 text-center text-red-600">Failed to load attendance summary</div>
        </CardContent>
      </Card>
    )
  }
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          <div className="space-y-2">
            ...
            <div className="text-primary text-2xl font-bold">{summary.totalDaysWorked}</div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="text-2xl font-bold text-blue-600">{summary.averageWorkingHours.toFixed(1)}h</div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {summary.records.slice(0, 3).map((record) => (
                <div key={record.id} className="flex items-center justify-between rounded-lg border p-2 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-muted-foreground">
                      ...
                      {record.clockOutTime ? format(record.clockOutTime, "HH:mm") : "Active"}
                    </span>
